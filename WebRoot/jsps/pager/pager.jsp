...
<script type="text/javascript">
	function _go() {
		...
		return location = "${pagebean.url}&pc="+pc;
	}
</script>
...
<div class="divBody">
	<div class="divContent">
		...
		<c:choose>
			...
			<c:otherwise>
				<a href="${pb.url}&pc=${pagebean.pc-1}" class="aBtn bold">上一页</a>
			</c:otherwise>
		</c:choose>
		...
		计算他们需要通过当前页码。
		1.总页数不足6  -->begin=1,end=最大页
		2.通过公式设置begin 和 end，begin=当前页-2，end=当前页+3
		...
		<%-- 共N页 到M页 --%>
		<span>共${pagebean.tp }页</span> <span>到</span> <input type="text"
			class="inputPageCode" id="pageCode" value="${pagebean.pc}" /> <span>页</span>
